...
| 실제 AI 모드 + `COMFY_CLOUD_API_KEY` + 그림 후보 보기 | OpenAI가 저장된 카드의 장면 설명을 만들고 Comfy가 FLUX.2 Dev (FP8), 1024×1024, 20 steps로 그림 1장을 생성합니다. |
