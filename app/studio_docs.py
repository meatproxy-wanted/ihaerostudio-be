...
for name in ("prepare_images", "image_candidates"):
    OPS[name]["description"] += (
        ...
        "기존 등장인물을 우선하며 새 인물은 원문에 현장 존재가 명확하고 설명에 필수일 때만 설계합니다. "
        "1컷·4컷 모두 지정한 인물 외 추가 인물·배경 인물을 넣지 않도록 지시하며 결과 검사·차단은 추가하지 않습니다. "
        "1컷·4컷 모두 각 인물의 옷 색을 자기 레퍼런스와 동일하게 유지하도록 공통 지시하며 구체적인 색 이름은 추정하지 않습니다. "
