...
| 실제 AI 모드 + `COMFY_CLOUD_API_KEY` + 그림 후보 보기 | OpenAI가 저장된 카드의 장면 설명을 만들고 Comfy가 등장인물 초상은 Qwen-Image-2512 (FP8, 768×768, 20 steps, CFG 4), 참조 없는 장면은 FLUX.2 Dev (FP8, 768×768, 20 steps), 참조 장면은 Qwen-Image-Edit-2511 (FP8, 20 steps, CFG 4)로 그림 1장을 생성합니다. |
