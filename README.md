...
등장인물 초상(`role=person`)은 **Qwen-Image-2512 (FP8), 512×512, 20 steps, CFG 4**로 생성합니다.
...
서버 설정은 공식 기본 50 steps 대신 20 steps이며, 초상 해상도는 1328×1328에서 512×512로 낮췄습니다.
...
참조 장면만 [공식 사용 예제](https://huggingface.co/Qwen/Qwen-Image-Edit-2511)의 40 steps로 조정하며 초상과 참조 없는 장면은 20 steps 그대로입니다.
